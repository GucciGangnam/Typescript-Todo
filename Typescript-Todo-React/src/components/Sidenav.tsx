...
// COMPONENT
export const Sidenav = ({ toggleTheme, isDarkMode, lists, setLists }: SidenavProps) => {
...
// Creating a new List 
    ...
    const handleNewListNameChange = (e: { target: { value: SetStateAction<string>; }; }) => {
